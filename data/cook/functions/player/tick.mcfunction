...
execute if score $base.timer_20 du_data matches 10 if score $temp_0 cook_data matches 1..3 run clear @s minecraft:written_book{cook_manual:1b}
execute if score $base.timer_20 du_data matches 10 if score $temp_0 cook_data matches 1..3 run function give:items/cooking_manual
