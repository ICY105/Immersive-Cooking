...
execute if score $base.timer_20 du_data matches 1 run function cook:player/reset_recipes
...
execute if score $base.timer_20 du_data matches 10 if score $temp_0 cook_data matches 1..4 run clear @s minecraft:written_book{cook_manual:1b}
execute if score $base.timer_20 du_data matches 10 if score $temp_0 cook_data matches 1..4 run function give:items/cooking_manual
