...
data modify entity @s CustomName set from entity @s ArmorItems[3].tag.cook.base_name
data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.smoked","italic":false,"with":[{"selector":"@e[tag=cook_smoking_item,tag=cook_temp]"}]}]'
