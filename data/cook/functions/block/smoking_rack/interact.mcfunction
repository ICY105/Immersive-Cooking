...
execute if score $in_0 cook_data matches 0 unless score @s cook_data matches 30.. if entity @p[tag=cook_interact,predicate=du:entity/is_sneaking,predicate=cook:holding_ingrediant,distance=..8] run function cook:block/smoking_rack/create_item_holder
