...
execute if score $in_0 cook_data matches 45 run data modify entity @s ArmorItems[3].tag.display.Lore[0] set value '{"translate":"lore.cook.perfectly_cooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 45 run scoreboard players add $in_1 cook_data 1
execute if score $in_0 cook_data matches 48 run data modify entity @s ArmorItems[3].tag.display.Lore[0] set value '{"translate":"lore.cook.cooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 48 run scoreboard players remove $in_1 cook_data 1

execute if score $in_0 cook_data matches 60 run data modify entity @s ArmorItems[3].tag.display.Lore[0] set value '{"translate":"lore.cook.slightly_overcooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 60 run scoreboard players remove $in_1 cook_data 1

execute if score $in_0 cook_data matches 70 run data modify entity @s ArmorItems[3].tag.display.Lore[0] set value '{"translate":"lore.cook.overcooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 70 run scoreboard players remove $in_1 cook_data 1

execute if score $in_0 cook_data matches 80 run data modify entity @s ArmorItems[3].tag.display.Lore[0] set value '{"translate":"lore.cook.burnt","italic":false,"color":"gray"}'
