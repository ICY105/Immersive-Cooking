...
execute if score $in_0 cook_data matches 240 run data modify entity @s ArmorItems[3].tag.display.Lore[-1] set value '{"translate":"lore.cook.overcooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 240 run scoreboard players remove $in_1 cook_data 2
