...
execute if score $in_0 cook_data matches 30 run data modify entity @s ArmorItems[3].tag.display.Lore append value '{"translate":"lore.cook.slightly_undercooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 30 run scoreboard players add $in_1 cook_data 1
execute if score $in_0 cook_data matches 30 run function cook:block/smoking_rack/complete_recipe

execute if score $in_0 cook_data matches 75 run data modify entity @s ArmorItems[3].tag.display.Lore[-1] set value '{"translate":"lore.cook.cooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 75 run scoreboard players add $in_1 cook_data 1

execute if score $in_0 cook_data matches 150 run scoreboard players add $in_1 cook_data 1

execute if score $in_0 cook_data matches 225 run data modify entity @s ArmorItems[3].tag.display.Lore[-1] set value '{"translate":"lore.cook.perfectly_cooked","italic":false,"color":"gray"}'
execute if score $in_0 cook_data matches 225 run scoreboard players add $in_1 cook_data 1
