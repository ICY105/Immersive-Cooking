...
#add liquid data
execute store result score $in_0 cook_data run data get entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.cook.food
scoreboard players operation $temp_7 cook_data += $in_0 cook_data
execute store result score $in_0 cook_data run data get entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.cook.quality
