...
### Set Name
data modify storage cook:temp var set from entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.liquid_item.tag.cook.base_name
execute store result score $temp_0 cook_data run data get storage cook:temp list

data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fry","italic":false,"with":[{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
execute if score $temp_1 cook_data = $temp_0 cook_data run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fried","italic":false,"with":[{"translate":"item.cook.mixed_vegetable"},{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
execute if score $temp_2 cook_data = $temp_0 cook_data run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fried","italic":false,"with":[{"translate":"item.cook.mixed_fruit"},{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
execute if score $temp_3 cook_data = $temp_0 cook_data run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fried","italic":false,"with":[{"translate":"item.cook.mixed_grain"},{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
execute if score $temp_4 cook_data = $temp_0 cook_data run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fried","italic":false,"with":[{"translate":"item.cook.mixed_protein"},{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
execute if score $temp_5 cook_data = $temp_0 cook_data run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.stir_fried","italic":false,"with":[{"translate":"item.cook.mixed_dairy"},{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
...
execute if score @s cook_data matches 89..91 run scoreboard players add $temp_8 cook_data 3
...
#add liquid data
execute store result score $in_0 cook_data run data get entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.liquid_item.tag.cook.food
scoreboard players operation $temp_7 cook_data += $in_0 cook_data
execute store result score $in_0 cook_data run data get entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.liquid_item.tag.cook.quality
...
execute if score @s cook_data matches ..69 run data modify block -29999999 0 1601 Items append value {		id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.undercooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 70..79 run data modify block -29999999 0 1601 Items append value {	id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.slightly_undercooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 80..99 run data modify block -29999999 0 1601 Items append value {	id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.cooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 82..85 run data modify block -29999999 0 1601 Items append value {	id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.perfectly_cooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 100..109 run data modify block -29999999 0 1601 Items append value {	id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.slightly_overcooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 110..119 run data modify block -29999999 0 1601 Items append value {	id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.overcooked","color":"gray","italic":false}']} }}
execute if score @s cook_data matches 120.. run data modify block -29999999 0 1601 Items append value {		id:"minecraft:firework_star",Count:1b,tag:{plate:2b,du_click_detect:1b,items:[],CustomModelData:6429410,cook:{type:8b,color:{red:0,green:0,blue:0}},HideFlags:32,Explosion:{Colors:[I;0]},display:{Name:'',Lore:['{"translate":"lore.cook.burnt","color":"gray","italic":false}']} }}
...
#store ingredients
data modify block -29999999 0 1601 Items[0].tag.seasonings set from entity @e[tag=cook_pan_liquid,distance=..0.1,limit=1] Item.tag.seasoning_items
