...
execute if score $in_0 cook_data matches 0 if score @s cook_data matches ..60 if entity @p[tag=cook_interact,predicate=cook:holding_ingrediant] run function cook:block/frying_pan/interact_create_holder
