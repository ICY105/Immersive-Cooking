...
execute if score @s cook_data matches 97..99 run scoreboard players add $temp_8 cook_data 4
...
execute if score @s cook_food matches 6..14 run scoreboard players add $temp_8 cook_data 2
