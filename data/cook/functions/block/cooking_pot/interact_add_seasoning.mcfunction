...
execute as @e[tag=cook_pot_liquid,distance=..0.1] unless data entity @s Item.tag.seasoning_items[3] run function cook:block/cooking_pot/interact_add_seasoning_2
