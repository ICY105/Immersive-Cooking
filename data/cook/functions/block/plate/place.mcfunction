...
#summon models
execute if score $temp_0 cook_data matches 1 run summon item_frame ~ ~ ~ {Tags:["cook_plate","cook_new","cook_interactable"],Invulnerable:1b,Invisible:1b,Facing:1b,Item:{id:"minecraft:tropical_fish",Count:1b,tag:{Facing:-1b,cook_id:9101,CustomModelData:6429101}}} 
