...
execute if score @s cook_data >= $temp_0 cook_data run loot give @p[tag=cook_interact] loot cook:tools/plate
execute if score @s cook_data >= $temp_0 cook_data positioned ~ ~-0.65 ~ run kill @e[tag=cook_plate_item,distance=..0.15]
