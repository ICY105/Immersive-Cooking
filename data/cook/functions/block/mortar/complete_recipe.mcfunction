...
#name and value
tag @s add cook_temp
execute if score $temp_0 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '{"translate":"item.cook.mashed","italic":false,"with":[{"selector":"@e[tag=cook_mortar_item,tag=cook_temp]"}]}'
...
execute if score $temp_0 cook_data matches 2 run data modify block -29999999 0 1602 Text1 set value '{"translate":"item.cook.ground","italic":false,"with":[{"selector":"@e[tag=cook_mortar_item,tag=cook_temp]"}]}'
...
execute if score $temp_0 cook_data matches 3 run data modify block -29999999 0 1602 Text1 set value '{"translate":"item.cook.juice","italic":false,"with":[{"selector":"@e[tag=cook_mortar_item,tag=cook_temp]"}]}'
...
execute if score $temp_0 cook_data matches 4 run data modify block -29999999 0 1602 Text1 set value '{"translate":"item.cook.flour","italic":false,"with":[{"selector":"@e[tag=cook_mortar_item,tag=cook_temp]"}]}'
