...
data modify storage cook:temp obj.tag.cooked merge value {id:"minecraft:cake",tag:{ cook:{ base_name:'', baking:0b } }}
...
execute if score $temp_0 cook_data matches 5 run data remove storage du:temp list[{tag:{cook:{milk:1b}}}]
...
#no added ingredient
data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.cake","italic":"false","with":[{"nbt":"var","storage":"cook:temp","interpret":true}]}]'
data modify storage cook:temp obj.tag.cooked.tag.cook.base_name set from block -29999999 0 1602 Text1 
data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.cake_batter","italic":"false","with":[{"nbt":"var","storage":"cook:temp","interpret":true}]}]'

#with added ingredient
execute if score $temp_0 cook_data matches 5 if data storage du:temp list[0] run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.cake","italic":"false","with":[{"nbt":"list[0].tag.cook.base_name","storage":"du:temp","interpret":true}]}]'
...
execute if score $temp_0 cook_data matches 5 if data storage du:temp list[0] run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.cake_batter","italic":"false","with":[{"nbt":"list[0].tag.cook.base_name","storage":"du:temp","interpret":true}]}]'
