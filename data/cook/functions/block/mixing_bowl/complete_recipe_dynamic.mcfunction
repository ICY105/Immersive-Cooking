...
execute if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}}]}]'
...
execute if score $temp_1 cook_data = $temp_8 cook_data if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed_vegetables","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}]}]'
...
execute if score $temp_2 cook_data = $temp_8 cook_data if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed_fruits","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}]}]'
...
execute if score $temp_3 cook_data = $temp_8 cook_data if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed_grains","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}]}]'
...
execute if score $temp_4 cook_data = $temp_8 cook_data if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed_proteins","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}]}]'
...
execute if score $temp_5 cook_data = $temp_8 cook_data if score $temp_6 cook_data matches 1 run data modify block -29999999 0 1602 Text1 set value '[{"translate":"item.cook.mixed_dairy","italic":false},{"translate":"item.cook.seasoned","with":[{"selector":"@e[tag=cook_mixing_bowl,tag=cook_temp]"}]}]'
