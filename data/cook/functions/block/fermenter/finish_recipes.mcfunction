...
execute if score $temp_0 cook_data matches 3 run data modify entity @s Item.tag.liquid_item.tag.cook merge value {food:1,quality:3,ferment:0b,alcohol:1b,wine:1b}
...
execute if score $temp_0 cook_data matches 4 run data modify entity @s Item.tag.liquid_item.tag.cook merge value {food:0,quality:4,ferment:0b,mead:1b}
...
execute if score $temp_0 cook_data matches 5 run data modify entity @s Item.tag.liquid_item.tag.cook merge value {food:3,quality:1,ferment:0b,alcohol:1b,cider:1b}
...
execute if score $temp_0 cook_data matches 6 run data modify entity @s Item.tag.liquid_item.tag.cook merge value {food:3,quality:1,ferment:0b,alcohol:1b,sake:1b}
...
execute if score $temp_0 cook_data matches 7 run data modify entity @s Item.tag.liquid_item.tag.cook merge value {food:4,quality:0,ferment:0b,alcohol:1b,beer:1b}
