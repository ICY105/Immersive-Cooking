...
execute unless score $minecraft.ver du_data matches 162 run tellraw @a [{"text":"Error: Immersive Cooking v0.1.0 requires Minecraft +1.16.2. Click [here] to download alternate versions.\n","color":"red","clickEvent":{"action":"open_url","value":"https://github.com/ImCoolYeah105/Immersive-Cooking/releases"}}]
...
execute if score $install cook_data matches 1 run tellraw @a [{"text":"[Loaded Immersive Cooking v0.1.0]","color":"dark_green"}]
